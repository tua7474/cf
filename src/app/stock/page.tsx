      ...
      <header className="bg-gray-500 text-white px-6 py-3 shadow flex items-center justify-between gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/booking-foy"
            className="px-4 py-1.5 text-sm rounded bg-yellow-400 hover:bg-yellow-300 text-orange-400 font-semibold transition-colors">
            📋 ใบจองกระดาษฝอย
          </Link>
        </div>
      </header>
                  ...
                  return (
                    ...
                    <tr className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-3 py-1.5 border-r border-gray-200 text-center">
                        <div className={`text-base font-bold ${stock < 0 ? 'text-red-600' : 'text-orange-400'}`}>
                      ...
                      <td className="px-2 py-1.5 border-r border-gray-200 min-w-[160px]">
                        <div className="text-[10px] text-gray-500 mb-1">
                          ล่าสุด: <span className="font-semibold text-orange-400">{fmtQty(item.last_added_qty)}</span>
                      ...
                      <td className="px-2 py-1.5 border-r border-gray-200 min-w-[160px]">
                        <div className="text-[10px] text-gray-500 mb-1">
                          ล่าสุด: <span className="font-semibold text-orange-400">{fmtQty(item.last_booked_qty)}</span>
                        ...
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => handleStock(item.id, 'book')}
                            ...
                            className="px-2 py-1 text-xs rounded bg-orange-100 hover:bg-orange-200 text-orange-800 border border-orange-400 transition-colors disabled:opacity-50 whitespace-nowrap">
                            − จอง
                          </button>
                      ...
                      <td className="px-3 py-1.5 border-r border-red-200 bg-red-50 text-right text-red-700 whitespace-nowrap font-medium">
                        ...
                        {hasPending && (
                          <button onClick={() => handleSaveInfo(item.id)}
                            ...
                            className={`mt-0.5 px-2 py-0.5 text-[10px] rounded font-semibold transition-colors disabled:opacity-50 whitespace-nowrap ${editDup ? 'bg-red-100 text-red-700 border border-red-300 cursor-not-allowed' : 'bg-yellow-400 hover:bg-yellow-300 text-orange-400'}`}>
